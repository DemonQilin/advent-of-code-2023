...
Consider [your entire calibration document](https://github.com/DemonQilin/advent-of-code-2023/blob/main/01-day-recover-calibration-value/src/improved-calibration.txt). What is the sum of all of the calibration values?

## Part Two

Your calculation isn't quite right. It looks like some of the digits are **_actually spelled out with letters_**: `one`, `two`, `three`, `four`, `five`, `six`, `seven`, `eight`, and `nine` also count as valid "digits".
